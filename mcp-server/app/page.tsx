    ...
    <main className="editorial editorial-home">
      <section className="editorial-hero">
        ...
        <div className="editorial-hero-grid">
          <section className="editorial-copy">
            <p className="editorial-kicker">Household coordination / simplified</p>
            <h1>
              Lists. People.
              <span>One home.</span>
            </h1>
            <p className="editorial-lede">
              A direct, private system for shared lists and todos—built for your household and the AI tools already doing the work.
            </p>
      ...
      <section className="editorial-how">
        <div className="editorial-how-heading">
          ...
          <h2>Three steps.<br />Zero confusion.</h2>
        </div>
...
function VideoPlaceholder() {
  return (
    <section className="editorial-video" aria-label="Portrait product video placeholder">
      <div className="editorial-video-top"><span>Portrait system film</span><span>9:16 / 01:24</span></div>
      <div className="editorial-video-art">
        ...
        <p>Home MCP: the 84-second introduction.</p>
      </div>
    </section>
  );
}
